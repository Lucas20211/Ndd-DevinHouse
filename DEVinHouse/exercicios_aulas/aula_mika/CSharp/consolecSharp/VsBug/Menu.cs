...
{
    public static void Show() // Tela de Menu
    {
        Console.Clear();
        DrawCanvas();
        ShowOptions();
    ...
    static void DrawCanvas() // Layout do Menu 01
    {
    ...
    static void ShowOptions() // Opções do menu
    {
    ...
    static void PrintHorizontLine() // Layout do Menu 02
    {
        Console.Write("+");
